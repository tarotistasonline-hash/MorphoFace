...
export default function GuestbookComments({ language }: GuestbookCommentsProps) {
  ...
  return (
    <div className="bg-stone-900/60 border border-stone-850/80 rounded-3xl p-6 sm:p-8 max-w-5xl mx-auto shadow-xl space-y-8" id="guestbook-container">
      
      {/* Header section of Guestbook */}
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-stone-850 pb-6">
        <div className="space-y-1.5">
          <div className="flex items-center gap-2">
            <div className="p-1.5 bg-amber-500/10 border border-amber-500/20 rounded-lg">
              <MessageSquare className="w-4 h-4 text-amber-400" />
            </div>
            <h2 className="text-lg font-bold font-sans tracking-tight text-stone-100 uppercase">
              {t.title}
            </h2>
          </div>
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-stone-800 hover:border-stone-700 bg-stone-950/40 text-[10px] font-mono text-stone-500 hover:text-stone-300 transition-all cursor-pointer"
